...
package com.common.stickyheader;
...
public class StickyHeaderDecoration extends RecyclerView.ItemDecoration {
     ...
     * @param adapter the sticky header adapter to use
     */
    public StickyHeaderDecoration(@NonNull StickyHeaderAdapter adapter, boolean renderInline, boolean isSticky) {
