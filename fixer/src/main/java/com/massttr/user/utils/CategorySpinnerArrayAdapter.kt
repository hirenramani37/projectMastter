...
import com.massttr.provider.databinding.CustomSpinnerBinding
import java.util.*

class CategorySpinnerArrayAdapter(
...
fun Spinner.setUpSpinnerCategory(spinnerDataList: ArrayList<String>, promptText: String = "") {
    this.run {
        if (promptText.isNotEmpty()) {
            spinnerDataList.add(0, promptText)
        }
        val spinnerListAdapter = CategorySpinnerArrayAdapter(
